    ...
    <Modal open={visible} onOk={setTrue} bodyStyle={{
      ...
      <div className="rounded-md text-brand-sub-txt bg-white p-4 z-auto">
        ...
        <div className="p-2 grid grid-cols-3 gap-4">
          <div className="compBtn" onClick={handleChange('AntButton', {
            children: '按钮',
            type: 'primary'
          })}>
            按钮
          ...
          <div className="compBtn" onClick={handleChange('AntPageHeader', {
            ghost: false,
            ...
            children: <Descriptions size="small" column={3}>
          ...
          <div className="compBtn" onClick={handleChange('AntResult', {
             status:"success",
          ...
          <div className="compBtn" onClick={handleChange('AntTable', {
              dataSource: [
                {
                  key: '1',
                  name: '胡彦斌',
          ...
          <div className="compBtn" onClick={handleChange('AntTabs', {
            items:[
